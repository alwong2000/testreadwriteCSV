...
//	private static final String COMMA_DELIMITER = ",";
	...
	//CSV file header
	private static final String FILE_HEADER = "rownum,brand,partnum,location,qty";

	public static void writeCsvFile(String fileName) {
		
		//Create new students objects
		Student student1 = new Student(1, "APEM", "ISR3SAD200", "HK", 25);
		...
		Student student6 = new Student(6, "APEM", "IPR1SAD2L0S", "HK", 21);
